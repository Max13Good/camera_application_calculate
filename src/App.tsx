      ...
      <div className="max-w-7xl mx-auto p-6 space-y-6">
        ...
        <Section title="Источники тарифов (ссылки)">
          <div className="text-sm leading-relaxed space-y-2">
            <p>
              Собрал страницы провайдеров, на основе которых заданы цены переменных издержек.
            </p>
            <ul className="list-disc pl-5 space-y-1">
              <li>
            ...
            <p className="text-xs text-gray-500">
              Примечание: я использую усреднения и простые допущения (например, 0.72 ГБ/час для relay, бесплатная ступень API 1 млн/мес и т.п.). Если нужно то можно подправить поля в блоке «Тарифы за единицу (RUB/USD)»
            </p>
          </div>
        </Section>
