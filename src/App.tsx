  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-900">
      <div className="max-w-7xl mx-auto p-6 space-y-6">
        ...
        {/* ===== Руководство ===== */}
        <Section title="Как пользоваться (коротко)">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-700">
            <div>
              <div className="font-semibold mb-1">Что делает калькулятор</div>
              <ul className="list-disc pl-5 space-y-1">
                <li>
                  Считает юнит‑экономику <b>на один облачный аккаунт</b> по каждому пакету: выручка, себестоимость (Tuya+Yandex), прибыль и маржа.
                </li>
                <li>
                  Умножает это на твой текущий <b>микс пакетов</b> и показывает сводные суммы по портфелю.
                </li>
                <li>
                  Строит <b>помесячный прогноз</b> (продажи, рост облачной базы, выручка/затраты/прибыль, кумулятивная прибыль) и <b>годовую сводку</b>.
                </li>
                <li>
                  Показывает графики: «Выручка/Себестоимость/Прибыль» и «Рост облачной базы».
                </li>
              </ul>
            </div>
            <div>
              ...
              <ul className="list-disc pl-5 space-y-1">
                <li>
                  Во вкладке «Калькулятор» задай исходные параметры: курс, размер базы, среднее камер на аккаунт, долю облака, трафик (Motion/Full), цены Tuya и Yandex.
                </li>
                <li>
                ...
                <li>
                  Смотри расчёт <b>на аккаунт</b> и <b>итоги по портфелю</b>.
                </li>
                <li>
                  Во вкладке «Прогноз» задай горизонт (мес), churn, продажи в 1‑й месяц, темп роста и долю облака у новых — ниже увидишь таблицу и графики.
                </li>
              </ul>
            </div>
          </div>
        ...
        <Section title="Источники тарифов (ссылки)">
          <div className="text-sm leading-relaxed space-y-2">
            <p>
              Собрал для тебя открытые страницы провайдеров, на основе которых заданы цены переменных издержек. Пожалуйста, периодически проверяй актуальность — провайдеры любят обновлять условия.
            </p>
            <ul className="list-disc pl-5 space-y-1">
              <li>
            ...
            <p className="text-xs text-gray-500">
              Примечание: я использую усреднения и простые допущения (например, 0.72 ГБ/час для relay, бесплатная ступень API 1 млн/мес и т.п.). Если нужно — подправь поля в блоке «Тарифы за единицу (RUB/USD)» и мультипликаторы под себя.
            </p>
          </div>
        </Section>
          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              <Section title="База / Пользователи">
                <div className="grid grid-cols-2 gap-x-3 gap-y-2 text-sm">
                  <label>
                    Курс ₽ за ${" "}
                    <Help text="Курс для перевода цен Tuya в рубли. Если что — подправь под себя." />
                  </label>
                  <input
                    className={inputCls}
                    type="number"
                  ...
                  <label>
                    Камер на аккаунт (ср.){" "}
                    <Help text="В среднем сколько камер у тебя на одном аккаунте." />
                  </label>
                  <input
                    className={inputCls}
                    type="number"
                  ...
                  <label>
                    Доля платящих (0..1){" "}
                    <Help text="Какая доля существующих аккаунтов платит (камеры/SMH/Bundle)." />
                  </label>
                  <input
                    className={inputCls}
                    type="number"
                  ...
                  <label>
                    ...
                    <Help text="Во сколько раз free‑аккаунт легче платного по нагрузке Tuya. 0.25 = четверть от платного." />
                  </label>
                  <input
                    className={inputCls}
                    type="number"
              ...
              <Section title="Трафик / Видео">
                <div className="grid grid-cols-2 gap-x-3 gap-y-2 text-sm">
                  ...
                  <label>
                    Битрейт (Мбит/с){" "}
                    <Help text="Для режима Full — чтобы понять, сколько ГБ в день набежит." />
                  </label>
                  <input
                    className={inputCls}
                    type="number"
                  ...
                  <label>
                    ...
                    <Help text="Сколько в среднем выходит за день при записи по событиям (Motion)." />
                  </label>
                  <input
                    className={inputCls}
                    type="number"
            ...
            <Section title="Сценарий распределения базы (платящие/бесплатные)">
              <div className="text-sm text-gray-700 mb-3">
                Доля облака — это доля платящих аккаунтов. Ниже задай, как платящие и бесплатные делятся по семействам. Если лень выставлять вручную — воспользуйся пресетами.
              </div>
              ...
              <Section title="Параметры прогноза (месяцы)">
                <div className="grid grid-cols-2 gap-x-3 gap-y-2 text-sm">
                  ...
                  <label>
                    ...
                    <Help text="Какую долю базы конкурентов ты заберёшь за весь период." />
                  </label>
                  <input
                    className={inputCls}
                    type="number"
                  ...
                  {competitorMode === "logistic" && (
                    <>
                      <label>
                        Крутизна S-кривой (k){" "}
                        <Help text="Чем больше k — тем резче рост в середине." />
                      </label>
                      <input
                        className={inputCls}
                        type="number"
                      ...
                      <label>
                        Середина (месяц){" "}
                        <Help text="Где пик скорости. Оставь пусто — возьму середину горизонта." />
                      </label>
                      <input
                        className={inputCls}
                        type="number"
